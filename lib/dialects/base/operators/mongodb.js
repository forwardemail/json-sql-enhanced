...
module.exports = function (dialect) {
  ...
  dialect.operators.comparison.set('$regex', function (field, value) {
    ...
    const options =
      (this.currentCondition && this.currentCondition.$options) || '';
  ...
  dialect.operators.comparison.set('$not', function (field, value) {
    if (typeof value === 'object' && value !== null) {
      ...
      for (const operator in value) {
        ...
        if (operator === '$regex') {
          const options = value.$options || '';
          const regexCondition = buildRegexCondition(
            this,
            field,
            value[operator],
            options
  ...
  dialect.operators.comparison.set(
    '$options',
    (_field, _options) =>
